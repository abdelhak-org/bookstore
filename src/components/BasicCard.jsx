...
function BasicCard({ title , url }) {
  const cuurl = "https://i.ibb.co/KqdgGY4/cosmetic-packaging-mockup-1150-40280.webp"
  return (
    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div className="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img className="h-80 rounded-t-lg mx-auto " src={url? url :cuurl} alt="product image"/>
            </a>
